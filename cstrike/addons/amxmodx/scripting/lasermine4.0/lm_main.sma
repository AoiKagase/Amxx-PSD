...
#define PLUGIN 						"[LM] Lasermine Core System"
...
public plugin_natives()
{
	...
	register_native("lm_add_mines", 				"_native_lm_add_mines");
	register_native("lm_set_user_delay_count",		"_native_lm_set_user_delay_count");
	register_native("lm_set_user_have_mine", 		"_native_lm_set_user_have_mine");
	register_native("lm_set_user_mine_deployed",	"_native_lm_set_user_mine_deployed");
	register_native("lm_set_user_deploy_state", 	"_native_lm_set_user_deploy_state");
	register_native("lm_get_user_delay_count", 		"_native_lm_get_user_delay_count");
	register_native("lm_get_user_have_mine", 		"_native_lm_get_user_have_mine");
	register_native("lm_get_user_mine_deployed", 	"_native_lm_get_user_mine_deployed");
	register_native("lm_get_user_deploy_state", 	"_native_lm_get_user_deploy_state");
}
...
public _native_lm_add_mines						(iPlugin, iParams)
{
	return lm_stock_add_mines(get_string(1));
}

public _native_lm_set_user_delay_count			(iPlugin, iParams)
	lm_stock_set_user_delay_count				(get_param(1), get_param(2), get_param(3));

public _native_lm_set_user_have_mine			(iPlugin, iParams)
	lm_stock_set_user_have_mine					(get_param(1), get_param(2), get_param(3));

public _native_lm_set_user_mine_deployed		(iPlugin, iParams)
	lm_stock_set_user_mine_deployed				(get_param(1), get_param(2), get_param(3));

public _native_lm_set_user_deploy_state			(iPlugin, iParams)
	lm_stock_set_user_deploy_state				(get_param(1), get_param(2), get_param(3));

public _native_lm_get_user_delay_count			(iPlugin, iParams)
	return lm_stock_get_user_delay_count		(get_param(1), get_param(2)); 			

public _native_lm_get_user_have_mine			(iPlugin, iParams)
	return int:lm_stock_get_user_have_mine		(get_param(1), get_param(2));		

public _native_lm_get_user_mine_deployed		(iPlugin, iParams)
	return int:lm_stock_get_user_mine_deployed	(get_param(1), get_param(2));

public _native_lm_get_user_deploy_state			(iPlugin, iParams)
	return int:lm_stock_get_user_deploy_state	(get_param(1), get_param(2));	

public _native_lm_progress_deploy_main			(iPlugin, iParams)
{
